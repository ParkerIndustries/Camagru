...
//        var_dump($login, $email, $password, $this->token);
    ...
    public function sendMail() {
        ...
        $header = "From: Noreply <noreply@camagru.com>";
        ...
        if (mail($this->email, $subject, $msg, $header)) {
            $message = "Mail of activation sent !";
            echo "<script type='text/javascript'>alert('$message');</script>";
            //alert("Mail of activation sent !");
        }
    }
    ...
    public function setActivate($login, $tok) {
        ...
        if ($status === '1') {
            ...
            if ($tok === $tokDB) {
                ...
                $message = "Error ! Your account may not be activated ...";
                echo "<script type='text/javascript'>alert('$message');</script>";
            }
        }
    }
    ...
    public function setNewPass($email, $tok, $password) {
        ...
        if ($reset == 1) {
            if ($tok == $tokDB) {
                ...
                $message = "Error ! Your account cannot be activated ...";
                echo "<script type='text/javascript'>alert('$message');</script>";
            }
        } else {
            $message = "Error password already updated";
            echo "<script type='text/javascript'>alert('$message');</script>";
        }
    }
